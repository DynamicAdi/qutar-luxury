    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        ...
        >
          ...
          <div className="mb-6">
            <h2 className="font-grotesk text-2xl font-semibold">Welcome back</h2>
            <p className="text-sm text-muted-foreground mt-1">Sign in to your QLP console</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11 rounded-xl bg-gradient-gold text-primary-foreground shadow-gold hover:opacity-95 transition-all">
              Sign in
            </Button>
          </div>
