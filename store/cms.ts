...
const seedProperties: Property[] = [
  ...
  },
  {
    ...
    images: [p2, p1], amenities: ["Concierge", "Rooftop Pool", "Gym", "Spa"],
  ...
  },
  {
    ...
    images: [p3, p1], amenities: ["Private Beach", "Boat Dock", "Helipad", "Pool", "Gym"],
  ...
  },
  {
    ...
    images: [p4], amenities: [], features: ["Corner Plot", "Road Access", "Utilities Ready"],
  ...
  },
  {
    ...
    images: [p5, p2], amenities: ["Pool", "Gym", "Concierge", "Kids Area"],
